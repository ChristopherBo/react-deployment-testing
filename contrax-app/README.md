...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/m4xaV9tiaK)
...
```sh
npx nx serve contrax-app
```

To create a production bundle:

```sh
npx nx build contrax-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project contrax-app
```
